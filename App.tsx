      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 scroll-smooth">
            <div className="max-w-7xl mx-auto pb-10">
                ...
                {activeTab === 'overview' && <OverviewDashboard data={filteredData} tierData={tierData} postLinks={postLinks} bonusCalData={bonusCalData} monthlyEarningData={monthlyEarningData} selectedMarketplaces={filters.marketplaces} />}
                {activeTab === 'lifecycle' && <LifecyclePerformance data={filteredData} />}
                {activeTab === 'earnings' && <EarningsTab adData={data} bonusCalData={bonusCalData} monthlyEarningData={monthlyEarningData} selectedMarketplaces={filters.marketplaces} />}
            </div>
        </main>
      </div>
    </div>
